	...
	<div class="page-container row-fluid">
		...
		<div class="page-content">
			...
			<div class="container-fluid" style="height: 800px">
				...
				<form name="items" action="add.do" method="post" style=" height: 800px">
        添加用户：
        ...
        <table width="100%" class="table table-striped table-hover table-bordered"
            ...
            <tr>
              ...
              <td>   <input  type="text" placeholder="商品名" name="name"  ></td>
              <td>      <input  type="text" placeholder="商品价格" name="price"  ></td>
              <td>     <input  type="text" placeholder="商品描述" name="detail"  ></td>
