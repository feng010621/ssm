		...
		<div class="page-content">
			...
			<div class="container-fluid" style="height: 800px">
				...
				<div class="clearfix">
							...
							<div class="btn-group">
							<form name="itemsFrom" action="add.jsp">
				...
				<form name="itemsFrom" action="" method="post" style=" height: 800px">
        商品列表：
        ...
        <table width="100%" border=1 class="table table-striped table-hover table-bordered"
            ...
            <c:forEach items="${selist}" var="item">
                <tr>
                    ...
                    <td>${item.detail}</td>
                    <td>
                    <a href="del.do?id=${item.id }">删除</a></br>
                    <a href="edit.do?id=${item.id }">修改</a></br>
                    </td>
